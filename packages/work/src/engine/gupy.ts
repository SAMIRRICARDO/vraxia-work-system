...
// Empresas alvo com seus slugs Gupy — inclui todas as 175 do ranking GPTW 2025
const GUPY_COMPANY_SLUGS: Record<string, string> = {
  ...
  'c&a': 'cea',
  'localiza': 'localiza',
  'solar coca-cola': 'solar-coca-cola',
  'totvs': 'totvs',
  'cogna': 'cogna',
  ...
  'viacredi': 'viacredi',
  'sap': 'sap-brasil',
  'sap labs': 'sap-labs-latin-america',
  'sap brasil': 'sap-brasil',
  'escola bahiana': 'escola-bahiana',
  'mag seguros': 'mag-seguros',
  'hilton': 'hilton',
  'sesc senac rs': 'sesc-rs',
  'cresol': 'cresol',
  'accor': 'accor',
  'volkswagen caminhões': 'volkswagen-caminhoes-e-onibus',
  'banco bv': 'banco-bv',
  'avanade': 'avanade',
  'mondelez': 'mondelez',
  'embracon': 'embracon',
  'supera farma': 'supera-farma',
  ...
  'scania': 'scania',
  'algar': 'algar',
  'unimed sul capixaba': 'unimed-sul-capixaba',
  'eurofarma': 'eurofarma',
  'ntt data': 'ntt-data-brasil',
  'tigre': 'tigre',
  'neovia': 'neovia',
  'grupo sabin': 'grupo-sabin',
  'supergasbras': 'supergasbras',
  'bayer': 'bayer-brasil',
  'bradesco seguros': 'bradesco-seguros',
  'unimed fortaleza': 'unimed-fortaleza',
  'sicoob credicitrus': 'sicoob-credicitrus',
  'yamaha': 'yamaha-motor',
  'unimed porto alegre': 'unimed-porto-alegre',
  'schneider electric': 'schneider-electric',
  'tivit': 'tivit',
  'ancar ivanhoe': 'ancar-ivanhoe',
  'serasa experian': 'serasa-experian',
  'experian': 'serasa-experian',
  'mercadinhos sao luiz': 'mercadinhos-sao-luiz',
  'capgemini': 'capgemini-brasil',
  'obramax': 'obramax',
  'aviva': 'aviva',
  'edenred': 'edenred',
  ...
  'sesi senac alagoas': 'sesi-alagoas',
  'somos sistemas': 'somos-sistemas',
  'ey': 'ey',
  'ernst young': 'ey',
  'engie': 'engie-brasil',
  'libbs': 'libbs',
  'grupo 3coracoes': 'grupo-3coracoes',
  ...
  'unidas': 'unidas',
  'cognizant': 'cognizant',
  // ── Pequenas Empresas (foco em TI) ───────────────────────────────────────
  'visagio': 'visagio',
  'bhs': 'bhs',
  'cisco': 'cisco',
  'salesforce': 'salesforce',
  'aptiv': 'aptiv',
  'dbc company': 'dbc-company',
  'encora': 'encora',
  'livelo': 'livelo',
  'e-core': 'e-core',
  'atlantico': 'atlantico',
  ...
  'sieg': 'sieg',
  'equinix': 'equinix',
  'mercado eletronico': 'mercado-eletronico',
  'pitang': 'pitang',
  'indicium': 'indicium',
  'eloware': 'eloware',
  'logcomex': 'logcomex',
  ...
  'metlife': 'metlife',
  'v360': 'v360',
  'icaro tech': 'icaro-tech',
  'coopersystem': 'coopersystem',
  'td synnex': 'td-synnex',
  'knightec': 'knightec',
  'alianzo': 'alianzo',
